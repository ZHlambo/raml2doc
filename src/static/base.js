    ...
    cm.operation(function() {
      if (isComment) { // Comment range
        ...
        if (startIndex > -1 && endIndex > -1 && endIndex > startIndex) {
          ...
          // From comment start till comment end + selText.substring(startIndex + curMode.commentStart.length, endIndex)
          // From comment end till string end + selText.substr(endIndex + curMode.commentEnd.length);
        }
